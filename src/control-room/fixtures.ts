...
export const scenarios: ControlRoomScenario[] = [
  {
    ...
    commit: {
      ...
      baseFingerprint: "commerce:v3:balance=86.40:refunded=0.00",
      currentFingerprint: "commerce:v3:balance=86.40:refunded=0.00",
    },
  ...
  },
  {
    ...
    commit: {
      ...
      capability: "PASS · refund:create",
      stateBinding: "PASS · candidate state is current",
      baseFingerprint: "commerce:v2:balance=148.00:refunded=0.00",
      currentFingerprint: "commerce:v2:balance=148.00:refunded=0.00",
    },
  ...
  },
  {
    ...
    commit: {
      ...
      stateBinding: "PASS · candidate state is current",
      baseFingerprint: "commerce:v1:balance=200.00:refunded=0.00",
      currentFingerprint: "commerce:v1:balance=200.00:refunded=0.00",
    },
  ...
  },
  {
    ...
    commit: {
      ...
      baseFingerprint: "commerce:v1:balance=36.00:refunded=0.00",
      currentFingerprint: "commerce:v2:balance=0.00:refunded=36.00",
    },
