  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <Link className="brand" href="/" aria-label="Return to Xact campaign"><span className="brand-mark">X</span><span><strong>XACT</strong><small>Control Room</small></span></Link>
