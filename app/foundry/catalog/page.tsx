...
export default function FoundryCatalogPage() {
  ...
  return <main className="foundry foundry-catalog-page">
    <header className="foundry-top"><Link href="/" aria-label="Xact Foundry home"><img className="foundry-logo" src="/xact-foundry-logo.webp" alt="Xact Foundry" /></Link><span>WEBMCP FOUNDRY</span><nav className="foundry-tabs" aria-label="Foundry pages"><Link href="/foundry">BOSS · BUILD A TOOL</Link><Link href="/foundry/catalog" aria-current="page">XACT BUILD &amp; EXAMPLES</Link></nav><strong>Approved recipes are not tools until Xact constructs and verifies them.</strong></header>
